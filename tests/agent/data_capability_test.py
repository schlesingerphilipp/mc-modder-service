...
EXPECTED = [(EXPECTED_FOLDER_PATH_STEP_1, EXPECTED_FILE_PATH_STEP_1, EXPECTED_CONTENT_STEP_1, None),
            ...
            (EXPECTED_FOLDER_PATH_STEP_4, EXPECTED_FILE_PATH_STEP_4, None, EXPECTED_CONTAINST_STEP_4),
            (EXPECTED_FOLDER_PATH_STEP_5, EXPECTED_FILE_PATH_STEP_5, None, None),
            (EXPECTED_FOLDER_PATH_STEP_6, EXPECTED_FILE_PATH_STEP_6, None, EXPECTED_CONTAINST_STEP_6),
           ]
